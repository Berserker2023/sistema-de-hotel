...
exports.registrarPago = async (req, res) => {
  try {
    ...
    // ✅ MODIFICADO: Permitir monto = 0 o negativo (solo validar que exista)
    if (!idReserva || monto === undefined || monto === null || !metodoPago) {
    ...
    // ✅ COMENTADO: Eliminar validación de monto > 0 para permitir negativos y cero
    // if (monto <= 0) {
    //   return res.status(400).json({
    //     success: false,
